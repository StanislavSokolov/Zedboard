...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zed 210248772877"} -index 0
dow D:/Projects/XilinxProjects/ZedBoard_test/ZedBoard_test.sdk/TestHellowWorld_bsp_xuartps_intr_example_1/Debug/TestHellowWorld_bsp_xuartps_intr_example_1.elf
